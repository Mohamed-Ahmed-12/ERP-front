...
import { EquipmentEmployeeWrite } from "../types/equipment";

const BASE_ENDPOINT = 'equipments/equipment-employee/';
export const EquipmentEmployeeService = {
    getAll: async () => {
        try {
    ...
    create: async (data: EquipmentEmployeeWrite) => {
        try {
    ...
    update: async (id: string, data: EquipmentEmployeeWrite) => {
        try {
