...
import { EquipmentWrite } from "../types/equipment";

const BASE_ENDPOINT = 'equipments/equipments/';
...
export const EquipmentService = {
    ...
    create: async (data: EquipmentWrite) => {
        try {
    ...
    update: async (id: string, data: EquipmentWrite) => {
        try {
